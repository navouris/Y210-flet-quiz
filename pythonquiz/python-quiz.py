...
class Player:
    players = {}
    players_file = os.path.join(_dir, "players.txt")
    @staticmethod
    def load_players():
        
        if Player.players_file in os.listdir(_dir):
            print("loading players...")
            for line in open(Player.players_file, "r", encoding="utf-8"):
                # print(line)
    ...
    def update_players(self):
        ...
        with open(Player.players_file, "w", encoding="utf-8") as file_out:
...
def load_quiz():
    ...
    replies = {}
    question = ""
    questions_file = os.path.join(_dir, "questions.txt")
    for line in open(questions_file, "r", encoding="utf-8"):
